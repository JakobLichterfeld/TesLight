  ...
  return (
    <div className="relative">
      <input
        ...
        className={twMerge(
          'focus-visible:sky w-full rounded-md bg-neutral p-1 text-center text-sky placeholder-sky placeholder-opacity-75 focus:outline-none focus-visible:ring focus-visible:ring-opacity-75 dark:bg-gray',
          className,
        )}
        {...props}
        {...field}
