  ...
  <ToastPrimitive.Provider>
    ...
    >
      <div className="flex">
        ...
        <div className="flex space-y-1 px-3 py-2">
          <ToastPrimitive.Close className="flex w-full items-center justify-center rounded-lg border border-transparent px-3 py-2 text-sm font-medium text-slate focus:z-10 focus:outline-none focus-visible:ring focus-visible:ring-sky focus-visible:ring-opacity-75 dark:text-neutral">
            Dismiss
